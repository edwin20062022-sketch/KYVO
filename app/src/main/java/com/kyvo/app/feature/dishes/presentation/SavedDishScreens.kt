...
@Composable private fun EmptyDishes(onCreate: () -> Unit) { KyvoStateView(Icons.Outlined.Search, "Aún no tienes platillos guardados", "Crea una combinación reutilizable de tus alimentos para registrarla rápidamente.", actionLabel = "Crear mi primer platillo", onAction = onCreate) }
