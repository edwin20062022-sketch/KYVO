...
data class FoodSearchResult(val id: String, val type: FoodType, val name: String, val subtitle: String?, val brand: String?, val imageKey: String?, val nutrients: FoodNutrients, val servingLabel: String?)
data class FoodDetail(val id: String, val type: FoodType, val name: String, val variant: String?, val imageKey: String?, val nutrients: FoodNutrients, val servings: List<FoodServing>)
